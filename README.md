...
## ***Catalogue And Serie :***<br><br><br><br>

#### To see the catalogue click on the catalogue button “Our catalogue”<br><br>

#### Once the choice made, click on the episode. Then play the video.<br><br><br>


## ***Favorites :***<br><br><br><br>

#### On the page "our catalogue" :<br><br>

- Click on any of this series
- Scroll through the page
- Click on "add to favorites" for adding it to your favorites
- Click on "remove from favorites" for removing it from your favorites
...
#### On the page "our catalogue" :<br>
- Click on any of this series
- Scroll through the page
- Select an episode by clicking on
- Back to your home page to enjoy your viewing in progress
...
#### Sorting by ketwords :<br>

- Type your keywords in the text area beside "Search keyword"
- Click on the search button
- 
#### Sorting by predefined element :<br>

- Place your cursor on top of the "Sort" button
- Move your cursor over "Title", "Date", "Year of creation" or "Description"
- Click on it
...
## ***Note and Comments :***<br><br><br><br>

It's possible to attribute a mark and comment to an episode.
Click on the button "mark"<br>
then you can select or enter a mark between 1 and 5.<br>
...
On the home page there is all the series you watched. You can continue your series where you stopped.<br><br><br><br>
